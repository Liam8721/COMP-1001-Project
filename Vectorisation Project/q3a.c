...
int getint(FILE* fp);
int realloc_function();
int malloc_function();

//CRITICAL POINT: images' paths - You need to change these paths
#define IN "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\input_images\\a1.pgm"
#define OUT "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\output_images\\blurred.pgm"
#define OUT2 "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\output_images\\edge_detection.pgm"
...
int main() {
	char filepath[80];
	char output_gaussian[80];
	char output_sobel[80];
	for (int i = 0; i < 31; i++){
		...
		sprintf(filepath, "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\input_images\\a%d.pgm", i);
		sprintf(output_gaussian, "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\output_images\\a%d_blurred.pgm", i);
		sprintf(output_sobel, "C:\\Users\\Liam\\Documents\\01 70\\Q3_a\\output_images\\a%d_edge.pgm", i);
